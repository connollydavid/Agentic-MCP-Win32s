/*
 * uart-probe.c - cross-platform diagnostic SPIKE (throwaway, NOT shipped device code).
 *
 ...
 * the missing-MSVCRT finding. Only kernel32 + user32 imports; all on the import allowlist.
